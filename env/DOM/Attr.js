...
; (function () {
    ...
    myVm.rename(Attr.prototype, "Attr");
    myVm.safeDescriptor_addConstructor(Attr);
    // debugger;
    myVm.safe_Objattribute(Attr, $safe_get_attribute, $safe_set_attribute, $safe_func_attribute);
